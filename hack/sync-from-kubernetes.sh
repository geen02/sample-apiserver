...
# 3. rewrite the history on that branch to *only* include staging/src/github.com/geen02/sample-apiserver
...
# this command rewrite git history to *only* include staging/src/github.com/geen02/sample-apiserver
git filter-branch -f --subdirectory-filter staging/src/github.com/geen02/sample-apiserver HEAD
