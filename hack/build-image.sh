...
function cleanup {
  rm "${KUBE_ROOT}/vendor/github.com/geen02/sample-apiserver/artifacts/simple-image/kube-sample-apiserver"
}
trap cleanup EXIT

pushd "${KUBE_ROOT}/vendor/github.com/geen02/sample-apiserver"
