...
mkdir -p ${goPath}/src/github.com/geen02/sample-apiserver
cp -R . ${goPath}/src/github.com/geen02/sample-apiserver

pushd ${goPath}/src/github.com/geen02/sample-apiserver
rm -rf vendor || true
...
mv ${goPath}/src/github.com/geen02/sample-apiserver/vendor .
mv ${goPath}/src/gthub.com/geen02/sample-apiserver/Godeps .
git add vendor
git add Godeps
